...
void snd_efw_stream_stop(struct snd_efw_t *efw, struct snd_efw_stream_t *stream);
void snd_efw_stream_destroy(struct snd_efw_t *efw, struct snd_efw_stream_t *stream);
